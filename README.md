...
mcpipboy mcp --enable echo,version

# Start with specific tools disabled
mcpipboy mcp --disable echo
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2024-11-05","capabilities":{"tools":{}},"clientInfo":{"name":"test-client","version":"1.0.0"}}}' | mcpipboy mcp
```
